...
<div class="row">
  ...
  ?><center>
    <div class="column6">
      ...
      <?php
      $sql=mysqli_query($conn,"SELECT Suggestion,User_id FROM complaints WHERE Suggestion IS NOT NULL");
      ...
      {
        echo "<script>alert('There are no suggestions registered');</script>";
