  ...
  ?><center>
    <div class="column6">
      ...
      <form action="" method="POST">
        <label for="book_id">User Id</label><br>
        <input type="text" name="user_id" value="<?php echo $user_id; ?>" placeholder="User Id" required/><br>
      ...
      { 
        ...
        if(is_numeric($user_id))
          ...
          $user_id=0;
        $sql1=mysqli_query($conn,"SELECT books.Book,books.Author,issues.User_id,issues.Issue_date,issues.Return_date from books,users,issues WHERE issues.User_id=users.Enrol_id AND issues.Book_id=books.Book_id and users.Enrol_id=".$user_id." ORDER BY Return_date LIMIT 12");
